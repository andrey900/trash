...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"OBJECT_ID" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("T_IBLOCK_OBJECT_ID"),
			"TYPE" => "STRING",
			"DEFAULT" => '={$_REQUEST["ID"]}'
		),
		"CAN_USER_DEL_REVIEW" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("CAN_USER_DEL_REVIEW"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"ALLOW_SOCSERV_USER_AUTHORIZATION" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ALLOW_SOCSERV_USER_AUTHORIZATION"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"NEWS_COUNT" => array(
