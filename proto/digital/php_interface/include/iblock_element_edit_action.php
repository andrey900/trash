...
<tr>
    <td style="text-align: center; width: 49%;">
        ...
        <select multiple size = "4" id="section_select" name="PROP[111][]">
    ...
    <td style="text-align: center; width: 49%;">
        ...
        <select multiple size = "4"<?if(empty($arBrands)):?> disabled="disabled"<?endif;?> id="brands_select" name="PROP[112][]">
        <?if(!empty($arBrands)):?>
        ...
        <input class="button" id="brand_select_button" type="submit" value="Подобрать элементы"<?if(empty($arBrands)):?> disabled="disabled"<?endif;?>>
    </td>
</tr>
<tr>
    <td colspan="2">
        ...
        <?foreach($arElements as $elem):?>
            <li><input name='PROP[110][]' type='checkbox' value='<?=$elem["ID"]?>'<?if(in_array($elem["ID"], $PROP["GOODS"]["VALUE"])):?> checked="checked"<?endif;?>><label for='<?=$elem["ID"]?>'><?=$elem["NAME"]?></label></li>
        <?endforeach;?>
        </ul>
    </td>
</tr>
