...
/*							$dbVAT = CCatalogProduct::GetVATInfo($arOfferItem['ID']);
					...
					$strOfferYandex .= "<item>\n";
                                        ...
                                        $strOfferYandex .= "<g:title>".yandex_text2xml($arOfferItem["~NAME"], true)."</g:title>\n";
                                        ...
                                        $strOfferYandex .= "</g:description>\n";
                                        $strOfferYandex .= "<g:link>http://".$ar_iblock['SERVER_NAME'].htmlspecialcharsbx($arOfferItem["~DETAIL_PAGE_URL"])."</g:link>\n";
					...
					if (!empty($strFile) || !empty($arItem['YANDEX_PICT']))
					{
						$strOfferYandex .= "<g:image_link>".(!empty($strFile) ? $strFile : $arItem['YANDEX_PICT'])."</g:image_link>\n";
                                        ...
                                        $strOfferYandex .= "<g:price>".$minPrice." UAH</g:price>\n";
                                        ...
                                        $strOfferYandex .= "<g:brand>".$vendorId."</g:brand>\n";
