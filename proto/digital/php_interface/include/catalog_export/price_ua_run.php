...
if (empty($arRunErrors))
{
	...
	@fwrite($fp, "<price date=\"".date('Y-m-d H:i')."\">\n");
...
/*							$dbVAT = CCatalogProduct::GetVATInfo($arOfferItem['ID']);
					...
					$strOfferYandex = '';
					$strOfferYandex .= "<item id=\"".$arOfferItem["ID"]."\">\n";
					...
					$strOfferYandex .= "<price>".$minPrice."</price>\n";
                                        ...
                                        if(!empty($minPriceCurrency)) {
                                            $strOfferYandex .= "<bnprice>".$minPriceCurrency."</bnprice>\n";
                                        } else {
                                            $strOfferYandex .= "<bnprice>".$minPrice."</bnprice>\n";
                                        }
					...
					if (!empty($strFile) || !empty($arItem['YANDEX_PICT']))
					{
						$strOfferYandex .= "<image>".(!empty($strFile) ? $strFile : $arItem['YANDEX_PICT'])."</image>\n";
                                        ...
                                        $strOfferYandex .= "<warranty>12</warranty>\n";
