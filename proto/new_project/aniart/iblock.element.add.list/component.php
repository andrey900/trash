...
/*
$db_props = CIBlockElement::GetProperty($arElement['IBLOCK_ID'], $arElement['ID'], array("sort" => "asc"), Array("ID"=>$arPropertyIDs/*"SHORT_NAME"));
if($ar_props = $db_props->Fetch())*/
	//echo "<pre>";print_r($arElement);
