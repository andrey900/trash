...
$log = new CFileLogger('/log/status/csoap_'.date('d-m-Y').'.log');
...
echo "<pre>";
//$t = $ultimaConnect->FGetAllGoodsActiveStatus();
//$t = $ultimaConnect->FGetLastGoodsActiveStatus(date('Y-m-d H:i:s', time()-36000));
//$t = $ultimaConnect->FGetGoodsActiveStatusFromId(array(22322));
$t = $ultimaConnect->GetLastModStatus();
print_r($t);
...
$ret = $ultimabitrix->execUpdateActiveStatus();
