...
class SoapClientFromUltima {
    ...
    public function GetAllGoodsActiveStatus()
    {
        $this->query->arGoodIds = array();
        $this->query->date = '';
        $this->_GetGoodsActiveStatus();
        return $this->arResult;
    }

    public function GetLastGoodsActiveStatus($date)
    {
        $this->query->arGoodIds = array();
    ...
    public function GetGoodsActiveStatusFromId($id=array(0))
    {
        $this->query->arGoodIds = (is_array($id))?$id:array(0);
        $this->query->date = '';
        $this->_GetGoodsActiveStatus();
    ...
    private function _GetGoodsActiveStatus(){
        $this->arResult = $this->client->GetGoodsActiveStatus($this->query->arGoodIds, 
                                                         $this->query->date,
                                                         43);
        return $this->_clearQueryParam();
    }
