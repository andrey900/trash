...
$MESS ['USER_PROPERTY_REQUIRED_FIELDS'] = "Обязательные доп. свойства";
$MESS ['ADD_GROUP'] = "Поместить в группы";
$MESS ['USE_CAPTCHA'] = "Использовать капчу";
$MESS ['LOGIN_EMAIL'] = "Использовать в качестве логина email";
$MESS ['CONFIRM_USER'] = "Запрашивать подтверждение по e-mail независимо от настроек сайта";
$MESS ['AUTO_PASS'] = "Автогенерация пароля и отправка его на почту пользователю";
$MESS ['CHEK_EMAIL'] = "Проверка email на уникальность";
?>