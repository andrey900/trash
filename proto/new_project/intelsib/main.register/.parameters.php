...
$rsGroups = CGroup::GetList(($by=""), ($order=""), $filter); // выбираем группы
while($group = $rsGroups->Fetch())
{
   if($group['ID']==1) continue;
   $groupU[$group['ID']] = $group['NAME'];
}
...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"USER_PROPERTY_REQUIRED_FIELDS"=>array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("USER_PROPERTY_REQUIRED_FIELDS"),
			"TYPE" => "LIST",
			"VALUES" => $userProp,
			"MULTIPLE" => "Y",
			"DEFAULT" => array(),
	   ...
	   "LOGIN_EMAIL" => array(
			"NAME" => GetMessage("LOGIN_EMAIL"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
			"PARENT" => "ADDITIONAL_SETTINGS",
		),
		"AUTO_PASS" => array(
			"NAME" => GetMessage("AUTO_PASS"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"PARENT" => "ADDITIONAL_SETTINGS",
		),
		"CONFIRM_USER"=>array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("CONFIRM_USER"),
			"TYPE" => "LIST",
			"VALUES" => array(0=>"Как в настройках сайта",'Y'=>'Да','N'=>'Нет'),
			"MULTIPLE" => "N",
			"DEFAULT" => array(),
		),
        "CHEK_EMAIL"=>array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("CHEK_EMAIL"),
			"TYPE" => "LIST",
			"VALUES" => array(0=>"Как в настройках сайта",'Y'=>'Да','N'=>'Нет'),
			"MULTIPLE" => "N",
			"DEFAULT" => array(),
