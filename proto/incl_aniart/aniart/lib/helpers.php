...
class Helpers
{
    ...
    public static function _GetHLItems($hlblock_id, array $filter = []){
        $hlblock = \Bitrix\Highloadblock\HighloadBlockTable::getById((int)$hlblock_id)->fetch();
