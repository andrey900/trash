<?
AddEventHandler("iblock", "OnBeforeIBlockElementUpdate", array("CIBlockExt", "OnBeforeIBlockElementUpdateHandler"));
AddEventHandler("iblock", "OnBeforeIBlockElementDelete", array("CIBlockExt", "OnBeforeIBlockElementDeleteHandler"));
AddEventHandler("iblock", "OnAfterIBlockSectionUpdate", array("CIBlockExt", "OnAfterIBlockSectionUpdateHandler"));
AddEventHandler("iblock", "OnAfterIBlockSectionDelete", array("CIBlockExt", "OnAfterIBlockSectionDeleteHandler"));
...
class CIBlockExt 
{
	...
	function OnBeforeIBlockElementUpdateHandler(&$arFields) { self::ClearCacheElement($arFields["ID"]); }
	function OnBeforeIBlockElementDeleteHandler($ID) { self::ClearCacheElement($ID); }
	function OnAfterIBlockSectionUpdateHandler(&$arFields) { self::ClearCacheSection($arFields["ID"]); }
	function OnAfterIBlockSectionDeleteHandler($arFields) { self::ClearCacheSection($arFields["ID"]); }
	 ...
	 * @return array
	 */
	function GetListSections($arFilter, $arSelect = array(), $arSort = array("sort" => "asc", "name" => "asc"), $limit = 25, $useCache = true, $useManagedCache = true, $useSEO = true)
	{
		global $CACHE_MANAGER;
		...
		if (\Bitrix\Main\Loader::includeModule("iblock"))
		{
			...
			else
			{
				...
				if ($obCache->InitCache(self::TTL_CACHE, serialize(array(__FUNCTION__, $arFilter, $arSelect, $arNavParams)), self::TAG_CACHE))
				{
	 ...
	 * @return array
	 */
	function GetListElements($arFilter, $arSelect = array(), $arSort = array("sort" => "asc", "name" => "asc"), $limit = false, $useCache = true, $useManagedCache = true, $useSEO = true)
	{
		global $CACHE_MANAGER;
	 ...
	 * @return array
	 */
	function GetElementInfo($arFilter = array(), $useCache = true, $useManagedCache = true, $useSEO = true)
	{
		if (empty($arFilter)) return;
	 ...
	 * @return array
	 */
	function GetSectionInfo($arFilter = array(), $useCache = true, $useManagedCache = true, $useSEO = true)
	{
		if (empty($arFilter)) return;
	 ...
	 * @param integer $elementID
	 */
	function SetBreadcrumbSection($iblockID, $sectionID, $nameSection = false, $useManagedCache = true)
	{
		if (\Bitrix\Main\Loader::includeModule("iblock"))
		{
			global $APPLICATION;
